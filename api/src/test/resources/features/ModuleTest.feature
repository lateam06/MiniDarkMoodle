...
#    But "Ernesto wants to add "Yann" to the module "Un super module d'enfer"
  ...
  Scenario: Teacher want to get all resources of his module
    ...
    * a course named "La lib standard" with a description "Quelques fonctions utiles"
    And "Marcel" adds the course "Les structures" to the post request to the module "le C pour les nuls"
    * "Marcel" adds the course "Les types" to the post request to the module "le C pour les nuls"
    * "Marcel" adds the course "La lib standard" to the post request to the module "le C pour les nuls"
